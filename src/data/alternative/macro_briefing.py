...
# ---------------------------------------------------------------------------
# Implementation note — keeping `timedelta` import alive
# ---------------------------------------------------------------------------
# ``timedelta`` is reserved for the planned policy/macro lookback narrowing
# that will live alongside ``time_window_days``. We import it here so future
# changes don't have to thread a fresh import through the existing helpers.
_RESERVED_TIMEDELTA = timedelta(days=DEFAULT_TIME_WINDOW_DAYS)
