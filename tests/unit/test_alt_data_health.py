...
def test_manifest_shape_post_phase_a_no_scaffolding_only():
    ...
    # NEA JSON), Phase F2 addition (fund_holdings), Phase F3 addition
    # (northbound), and block_trades must all be present so the manifest stays in sync.
