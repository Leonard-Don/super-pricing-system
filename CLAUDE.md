...
tests/          unit / integration / manual / e2e (custom Node verify_*.js scripts in tests/e2e/)
...
| `research-e2e` | Custom Node verify_*.js research suite using Playwright (depends on backend+frontend passing) | `cd tests/e2e && npm run verify:research` |
