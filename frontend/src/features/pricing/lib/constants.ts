...
export const DEFAULT_SCREENING_UNIVERSE = 'AAPL\nMSFT\nNVDA\nAMZN\nGOOGL';

export const ALIGNMENT_TAG_COLORS: Record<string, string> = {
  aligned: 'green',
  conflict: 'red',
  partial: 'gold',
  neutral: 'default',
...
export const RANGE_BASIS_LABELS: Record<string, string> = {
